      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mt-4 glass rounded-full px-5 py-3 flex items-center justify-between gap-2">
          <Link href="/" className="flex items-center gap-2 font-display font-bold text-lg tracking-tight shrink-0">
            <span className="grid place-items-center size-8 rounded-full bg-gradient-to-br from-teal-500 via-emerald-500 to-cyan-400 text-white text-base">
              🧠
            </span>
            {APP_NAME}
          </Link>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link
              href="/personality"
              className="hidden sm:inline-flex rounded-full bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white text-sm font-semibold px-4 py-2 transition-all hover:shadow-lg hover:shadow-emerald-500/25"
            >
              Test my personality
            </Link>
            <button
          ...
          {open && (
            ...
            >
              ...
              <Link
                href="/personality"
                onClick={() => setOpen(false)}
                className="mt-1 rounded-2xl bg-gradient-to-r from-teal-600 to-emerald-600 text-white text-center text-sm font-semibold px-4 py-3 hover:from-teal-500 hover:to-emerald-500 transition-colors"
              >
                Test my personality ✨
              </Link>
              <Link
...
export function BackgroundFX() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden -z-10">
      <div className="absolute -top-32 -left-32 size-[28rem] rounded-full bg-teal-400/35 dark:bg-teal-600/25 blur-[120px] animate-float-slow" />
      <div className="absolute top-1/3 -right-40 size-[26rem] rounded-full bg-emerald-400/30 dark:bg-emerald-600/20 blur-[120px] animate-float-slower" />
