...
export function BackgroundFX() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden -z-10">
      <div className="absolute -top-32 -left-32 size-[28rem] rounded-full bg-violet-600/25 blur-[120px] animate-float-slow" />
      <div className="absolute top-1/3 -right-40 size-[26rem] rounded-full bg-fuchsia-600/20 blur-[120px] animate-float-slower" />
      <div className="absolute bottom-0 left-1/4 size-[24rem] rounded-full bg-cyan-500/15 blur-[120px] animate-float-slow" />
      <div
