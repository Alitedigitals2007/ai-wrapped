            ...
            {CARD_TITLES.map((t, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === index ? "w-6 bg-gradient-to-r from-teal-500 to-emerald-500 dark:from-teal-400 dark:to-emerald-400" : "w-2 bg-black/15 dark:bg-white/15 hover:bg-black/30 dark:hover:bg-white/30"
                )}
              />
            ))}
          </div>
